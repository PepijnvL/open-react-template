...
export default function BinaryStreamV2() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setGrid((prev) => {
        ...
        // Change 4-6 random cells
        const changes = Math.floor(Math.random() * 3) + 4;
    ...
    }, 120); // Faster animation for more dynamic effect
  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
      ...
      >
        ...
        {/* Binary Grid with spring animations - KEY FIX: This is the actual animation */}
                ...
                <motion.span
                  ...
                  animate={{
                    ...
                    textShadow: cell.value === "1"
                      ...
                      : "none",
                    scale: cell.isChanging ? [1, 1.4, 1] : 1,
                  }}
                  transition={{
                    type: "spring",
                    stiffness: 500,
