        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.gray.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-16">
            ...
            <p className="text-lg text-purple-200/65">
              Create workflows with AI agents that can access any integration—whether built by us, you, or added as an MCP tool.
              The platform built for agentic automation.
            </p>
          </div>
              ...
              <div className="relative flex flex-col items-center">
                <div className="relative z-10 mb-8">
                  ...
                  <div className="mt-4 text-center">
                    <div className="font-nacelle text-xl font-bold text-white">AI Agent</div>
                    <div className="text-sm text-purple-300">Claude, GPT-4, or any LLM</div>
                  </div>
                </div>
                  ...
                  {[
                    {
                      ...
                      description: "Slack, Gmail, Shopify, Notion...",
                      color: "indigo",
                    },
                    {
                      icon: (
                      ...
                      description: "Build your own in minutes",
                      color: "purple",
                    },
                    {
                      icon: (
                      ...
                      title: "MCP Tools",
                      description: "Add any MCP tool as an action",
                      color: "cyan",
                    },
                  ].map((tool, index) => (
                    <div key={index} className="group relative">
                      {/* Connection line to center (visual only, simplified) */}
                      <div className={`absolute bottom-full left-1/2 h-8 w-px bg-gradient-to-b from-${tool.color}-500/50 to-transparent`} />

                      <div className={`rounded-xl border border-${tool.color}-500/20 bg-gradient-to-br from-${tool.color}-500/5 to-transparent p-6 text-center transition-all hover:border-${tool.color}-500/40 hover:shadow-[0_0_20px_rgba(147,51,234,0.15)]`}>
                        <div className="mb-3 inline-flex items-center justify-center rounded-lg bg-gray-900/50 p-3">
                          <svg className={`h-8 w-8 text-${tool.color}-400`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            {tool.icon}
                          </svg>
                        </div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div
              className="group relative overflow-hidden rounded-xl border border-gray-800/50 bg-gradient-to-br from-gray-900/50 to-gray-950/50 p-6 backdrop-blur-sm transition-all hover:border-purple-500/30 hover:shadow-[0_0_20px_rgba(147,51,234,0.1)]"
              data-aos="fade-up"
            >
              <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-purple-500/10 px-3 py-1 text-xs font-medium text-purple-400">
