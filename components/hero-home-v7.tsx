...
export default function HeroHomeV7() {
  return (
        ...
        <div className="py-8 md:py-12 lg:py-16">
          ...
          <div className="pb-12 text-center md:pb-16 lg:pb-20">
            ...
            <div className="mx-auto max-w-3xl">
              ...
              {/* Audience navigation */}
              <div
                className="mb-10 flex flex-wrap items-center justify-center gap-4 text-sm"
                data-animate="fade-up"
          ...
          <div data-animate="fade-up" data-animate-delay="500">
            <ModalVideo
              thumb={VideoThumb}
              thumbWidth={1104}
              thumbHeight={576}
