        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-4">
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Leverage advanced AI models to analyze data, generate content,
                make decisions, and automate complex tasks intelligently.
              </p>
            </article>
            <article>
              <svg
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Monitor your workflows in real-time with detailed analytics and logs.
